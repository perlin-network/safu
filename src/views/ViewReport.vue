    ...
    <div v-if="report" class="pa3">
      <div class="cf w-100">
        <div class="fl w-25 pr2">
          <div class="w-100 tl f2">Submitter</div>

          <div class="outline bg-white mt3">
            <div class="pa2">
              <code
                class="f7 w-100 h-25 nowrap fl bg-black-20 pa2 ws-normal overflow-hidden dib"
              >{{ targetAddress }}</code>
            </div>
            ...
            <div class="mt4 mb3 pl3 outline pv2">
              <div class="dt w-100">
                ...
                <div class="dtc w-50 pr3 tr">
                  <a href="#" class="f6 black-50 dib" @click="openReputation">16</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="fl w-75 pl2">
          ...
          <div class="mt3 outline pa3">
            <vue-markdown class="overflow-y-auto" style="max-height: 350px;">{{report.content}}</vue-markdown>
          </div>
          ...
          <div class="dt w-100 mt3">
            ...
            <div class="dtc w-60">
              <div
                v-for="(rep, i) in reps"
                :key="i"
                class="pa2 mb3 bg-black-10 outline tooltip mr2"
                :class="rep.type === '+' ? ['bg-green', 'white'] : ['bg-light-red', 'white']"
              >
                <span class="tooltipText">
                  {{rep.from}} gave {{rep.type}}rep to {{rep.to}}.
                  <br>
                  <b>reason:</b>
                  {{rep.reason}}
                </span>
      ...
      <div v-if="showReputation">
        <Reputation :close="closeReputation" :targetAddress="targetAddress"/>
      </div>
    </div>
  </Layout>
</template>
...
export default {
  data() {
    return {
      ...
      targetAddress:
        "0x3jg4sff02bae6764991eefe53360a0a09be53887b2d3900d02c00a3858",
      reps: [
        {
          from: "alice",
          to: "bob",
